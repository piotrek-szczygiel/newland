...
{
	DayNightColorsInfo(sf::Color color, bool lights):color(color),lights(lights){}
	sf::Color color;
	bool lights;
};
...
public:
	...
	void			Draw(sf::RenderWindow &rt, sf::RenderStates states, Player* player, float runTime, float frameTime, int daynightType);
};
