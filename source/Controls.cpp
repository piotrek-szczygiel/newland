...
float Controls::Moving(int direction)
{
	...
	else if(device == DeviceKeyboard)
	{
		...
		{
		case DirectionY:
			if(sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Up)) return -100;
			else if(sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Down)) return 100;
			break;
		case DirectionX:
			if(sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Right)) return 100;
			else if(sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Left)) return -100;
			break;
		}
	}
