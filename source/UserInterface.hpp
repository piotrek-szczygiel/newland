...
public:
	...
	static void Popup(std::wstring wstr, sf::Vector2f centerPosition, float hideTime = 2.0f, sf::Color color = sf::Color::White, bool eraseLast = false);
	static void Popup(std::wstring wstr, Player* player, float hideTime = 2.0f, sf::Color color = sf::Color::White, bool eraseLast = false);
	static void InteractionPopup(std::wstring wstr, sf::Vector2f centerPosition, int button, float hideTime = 2.0f, sf::Color color = sf::Color::Magenta, bool eraseLast = false);
